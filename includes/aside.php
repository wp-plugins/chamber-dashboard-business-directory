...
<div id="sidebar" style="width: 28%; float: right; min-width: 150px; background: #fff; border: 1px solid #999; padding: 6px">
	...
	<p><?php _e('Engage your community in local events, with our <a href="https://chamberdashboard.com/features/chamber-dashboard-events-calendar/?utm_source=plugin&utm_medium=sidebar&utm_campaign=business-directory" target="_blank">event calendar</a> plugin.', 'cdashmm'); ?></p>
    <p><?php _e('Accept <a href="https://chamberdashboard.com/features/chamber-dashboard-member-manager/?utm_source=plugin&utm_medium=sidebar&utm_campaign=business-directory" target="_blank">Member Payments</a> and invoice your members, straight from your site.  Save staff time with auto-invoicing.', 'cdashmm'); ?></p>
	<p><?php _e('<a href="https://chamberdashboard.com/features/crm/?utm_source=plugin&utm_medium=sidebar&utm_campaign=business-directory" target="_blank">Track and Catalog your Contacts</a> – Trade your collection of Excel spreadsheets for a CRM that lets you track calls and meeting attendance, categorize your contacts, gives your staff shared access to the same data and more.', 'cdashmm'); ?></p>  

	<h3><?php _e('Connect', 'cdashmm'); ?></h3>
	<p><?php _e('<a href="https://chamberdashboard.com/chamber-dashboard-user-map/?utm_source=plugin&utm_medium=sidebar&utm_campaign=business-directory" target="_blank">Get On the Map</a> – We have users around the world!  We\'d love to link to your site too.', 'cdashmm'); ?></p>
